...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private double latRusADouble = 13.859810;
    private double lngRusADouble = 100.481582;
    ...
    private void myLoop() {
        ...
        Log.d("RusV3", "latUser ==> " + lngUserADouble);
    ...
    private void editLatLngOnServer() {
        ...
        String urlPHP = "http://swiftcodingthai.com/rus/edit_location_aoh.php";
